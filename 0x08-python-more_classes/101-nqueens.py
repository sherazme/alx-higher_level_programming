...
def init_board(n):
    """Initialize an nxn sized chessboard with 0"""
    board = []
...
def get_solution(board):
    """Return list of lists containing solved chessboard."""
    solution = []
...
def xout(board, row, col):
    ...
    longer be played are Xout

    Args:
        board (list): current chessboard
        row (int): row where queen last played
        col (int): column where queen last played.
    """
